 ...
 * @author Jesse Houk
 */
public class RepairOrdersFrame extends javax.swing.JFrame {
    private DBConnection conn;
    private RepairOrdersDAO RODAO;
    private List<RepairOrder> repairOrders;
    RepairOrdersTableModel model;
    /**
     * Creates new form RepairOrdersFrame
     */
    public RepairOrdersFrame(RepairOrdersDAO myConn) {
        initComponents();
        conn = myConn;
        RODAO = new RepairOrdersDAO(conn);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RepairOrdersFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RepairOrdersFrame().setVisible(true);
            }
        });
    }
